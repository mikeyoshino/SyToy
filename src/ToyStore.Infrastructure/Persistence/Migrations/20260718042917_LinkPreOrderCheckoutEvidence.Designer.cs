...
namespace ToyStore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260718042917_LinkPreOrderCheckoutEvidence")]
    partial class LinkPreOrderCheckoutEvidence
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ToyStore.Domain.Checkouts.CheckoutAttempt", b =>
                {
                    ...
                    b.ToTable("CheckoutAttempts", null, t =>
                        {
                            t.HasCheckConstraint("CK_CheckoutAttempts_Amounts", "\"FullPrice\" > 0 AND \"DepositAmount\" > 0 AND \"BalanceAmount\" > 0 AND \"PaymentAmount\" > 0");

                            t.HasCheckConstraint("CK_CheckoutAttempts_Expiry", "\"ExpiresAtUtc\" > \"CreatedAtUtc\"");

                            t.HasCheckConstraint("CK_CheckoutAttempts_Quantity_Positive", "\"Quantity\" > 0");
            ...
            modelBuilder.Entity("ToyStore.Domain.Orders.Order", b =>
                {
                    ...
                    b.OwnsOne("ToyStore.Domain.Orders.OrderItem", "Item", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<decimal>("BalanceAmount")
                                .HasPrecision(18, 2)
                                .HasColumnType("numeric(18,2)")
                                .HasColumnName("ItemBalanceAmount");
                            ...
                            b1.Property<decimal>("DepositAmount")
                                .HasPrecision(18, 2)
                                .HasColumnType("numeric(18,2)")
                                .HasColumnName("ItemDepositAmount");

                            b1.Property<string>("DepositPolicy")
                                .IsRequired()
                                .HasMaxLength(100)
                                .HasColumnType("character varying(100)")
                                .HasColumnName("ItemDepositPolicy");

                            b1.Property<string>("DisplayName")
                                .IsRequired()
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("ItemDisplayName");

                            b1.Property<string>("EnglishName")
                                .IsRequired()
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("ItemEnglishName");
                            ...
                            b1.Property<decimal>("FullPrice")
                                .HasPrecision(18, 2)
                                .HasColumnType("numeric(18,2)")
                                .HasColumnName("ItemFullPrice");

                            b1.Property<decimal>("LinePaidAmount")
                                .HasPrecision(18, 2)
                                .HasColumnType("numeric(18,2)")
                                .HasColumnName("ItemLinePaidAmount");

                            b1.Property<DateTimeOffset>("PreOrderCloseAtUtc")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("ItemPreOrderCloseAtUtc");

                            b1.Property<string>("PrimaryImageUrl")
                                .IsRequired()
                                .HasMaxLength(1000)
                                .HasColumnType("character varying(1000)")
                                .HasColumnName("ItemPrimaryImageUrl");
                            ...
                            b1.Property<string>("ProductSlug")
                                ...
                                .HasMaxLength(240)
                                .HasColumnType("character varying(240)")
                                .HasColumnName("ItemProductSlug");

                            b1.Property<int>("Quantity")
                                .HasColumnType("integer");

                            b1.Property<string>("UniverseName")
                                .IsRequired()
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("ItemUniverseName");
