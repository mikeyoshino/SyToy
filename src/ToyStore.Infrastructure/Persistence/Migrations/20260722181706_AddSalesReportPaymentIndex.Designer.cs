...
namespace ToyStore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260722181706_AddSalesReportPaymentIndex")]
    partial class AddSalesReportPaymentIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToyStore.Domain.Addresses.SavedAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SavedAddresses", null, t =>
                        {
                            t.HasCheckConstraint("CK_SavedAddresses_LocationIds_Positive", "\"ProvinceId\" > 0 AND \"DistrictId\" > 0 AND \"SubDistrictId\" > 0");

                            t.HasCheckConstraint("CK_SavedAddresses_UpdatedAfterCreated", "\"UpdatedAtUtc\" >= \"CreatedAtUtc\"");
                        });
                });
                    ...
                    b.ToTable("CheckoutAttemptItems", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_CheckoutAttemptItems_SaleShape", "(\"SaleType\" = 'InStock' AND \"DepositAmount\" = 0 AND \"BalanceAmount\" = 0 AND \"PreOrderCloseAtUtc\" IS NULL AND \"DepositPolicy\" IS NULL) OR (\"SaleType\" = 'PreOrder' AND \"DepositAmount\" > 0 AND \"BalanceAmount\" > 0 AND \"PreOrderCloseAtUtc\" IS NOT NULL AND \"DepositPolicy\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ToyStore.Domain.Notifications.NotificationDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SafeProviderResponse")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("ToyStore.Domain.Orders.Order", b =>
                {
                    ...
                    b.ToTable("Orders", null, t =>
                        {
                            t.HasCheckConstraint("CK_Orders_Shipped_Timestamp", "(\"FulfillmentStatus\" = 'Shipped' AND \"ShippedAtUtc\" IS NOT NULL) OR (\"FulfillmentStatus\" <> 'Shipped' AND \"ShippedAtUtc\" IS NULL)");

                            t.HasCheckConstraint("CK_Orders_Version_Positive", "\"Version\" > 0");
                        });
                });

            modelBuilder.Entity("ToyStore.Domain.Orders.OrderAuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OrderAuditEvents", (string)null);
                });
            ...
            modelBuilder.Entity("ToyStore.Domain.Orders.Shipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ToyStore.Domain.Products.ProductImage", b =>
                {
                    ...
                    b.Property<string>("ThumbnailPublicRelativeUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.ToTable("ProductImages", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ProductImages_Thumbnail_AllNullOrPresent", "(\"ThumbnailStorageKey\" IS NULL AND \"ThumbnailPublicRelativeUrl\" IS NULL) OR (\"ThumbnailStorageKey\" IS NOT NULL AND \"ThumbnailPublicRelativeUrl\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("ToyStore.Domain.Orders.Shipment", b =>
                {
                    b.HasOne("ToyStore.Domain.Orders.Order", null)
                        .WithOne()
                        .HasForeignKey("ToyStore.Domain.Orders.Shipment", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
