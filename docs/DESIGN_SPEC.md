...
- ส่วนสินค้าแนะนำบน Home แสดงสูงสุด 8 รายการ และ Catalog แบ่งหน้า 8 รายการ โดยรายการ Storefront เรียงสินค้าที่แก้ไขล่าสุดก่อนด้วย `UpdatedAtUtc` และใช้ Product Id เป็น stable tie-breaker; shared product grid เรียงตามขนาดจอเป็น mobile 2 คอลัมน์, tablet 3 คอลัมน์ และ desktop ขนาดใหญ่ 4 คอลัมน์ รวมถึง Catalog ที่ใช้ large-card mode เพื่อให้แนวการ์ดพอดีกับพื้นที่หน้าจอ
...
- Product Create/Edit ใช้ large modal บนหน้า list; mobile เป็น full-screen dialog; แถว Draft และ Published ต้องมีปุ่มแก้ไขที่มองเห็นได้ โดย Published บันทึกแล้วอัปเดตหน้าร้านทันที; Published Pre-order ล็อกวันปิดรอบ แต่เปิดให้ปรับจำนวนรับก่อนปิดรอบพร้อม help/error ภาษาไทยและห้ามต่ำกว่ายอดที่ถูกใช้แล้ว; Brand/Universe ใช้ modal pattern เดียวกัน
